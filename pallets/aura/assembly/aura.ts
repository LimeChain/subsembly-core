import { Timestamp } from "@subsembly-core/timestamp";
import { Storage } from "@subsembly-core/modules";
import { InherentData, Option } from "@subsembly-core/models";
...
export class Aura {
    ...
    static checkInherent(t: u64, data: InherentData): bool {
        ...
        const timestampBasedSlot = t / Aura.getSlotDuration();
...
export function auraInherentData(inhData: InherentData): u64 {
    return inhData.data[Aura.INHERENT_IDENTIFIER];
}